...
question(
    '(Who|What) are you',
    reply(
        'I\'m Bongo, your virtual agent',
        'I\'m Bongo. What can I help you with?',
    ),
);
...
question(
    ...
    reply(
        ...
        'I\'m an advanced AI',
        'I\'m not a $(Q chatbot), I\'m Bongo (your virtual agent|).',
    ),
);
...
question(
    'My name is $(NAME)',
    reply('(Nice to meet you|Hi|Hello) $(NAME) (I\'m Bongo|my name is Bongo|)'),
);
...
question(
    ...
    reply('I\'m Bongo, a virtual agent, (within this application.|) (I can help you get what you need|I can help you with anything within my programming).'),
);
...
question(
    ...
    'Who are you?',
    reply(
        '(My name is|It\'s) Bongo, what\'s yours?',
        follow(
...
question(
    ...
    reply(
        'I\'m not $(Q), I\'m Bongo',
        'You must be thinking of someone else. I\'m Bongo, not $(Q)',
    ),
);
